...
static const struct gpadc_data sun50i_a64_gpadc_data = {
	/*
	 * Datasheet says Raw = -8.56*T + 2170 - well it means that anyway, I think
	 * so T = (2170-Raw)/8.56 or (2170-Raw)*.1168, but we want it in millis so it is
	 * T(milliC) = (Raw-2170)*(-117)
	 */
	.temp_offset = -2170,
	.temp_scale = -117,
	.temp_divider = 1,
...
static const struct of_device_id sun4i_gpadc_of_id[] = {
	...
	{
		.compatible = "allwinner,sun8i-a64-ths",
